		...
		return { //this:ActionBasciFsm
				...
				state("turnOn") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t01",targetState="turnOff",cond=whenTimeout("local_tout_"+name+"_turnOn"))   
					transition(edgeName="t02",targetState="doSynch",cond=whenEvent("synch"))
					transition(edgeName="t03",targetState="doDesynch",cond=whenEvent("desynch"))
				}	 
				state("turnOff") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t04",targetState="checkSynch",cond=whenTimeout("local_tout_"+name+"_turnOff"))   
					transition(edgeName="t05",targetState="doSynch",cond=whenEvent("synch"))
					transition(edgeName="t06",targetState="doDesynch",cond=whenEvent("desynch"))
				}	 
