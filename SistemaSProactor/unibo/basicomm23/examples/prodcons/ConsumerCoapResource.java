...
public class ConsumerCoapResource  extends CoapResource implements IApplMsgHandler {
    ...
    public void handleGET(CoapExchange exchange) {
        CommUtilsOrig.outmagenta(getName() + " | handleGET " + exchange.getRequestText());
    ...
    public void handlePOST(CoapExchange exchange) {
        CommUtilsOrig.outmagenta(getName() + " | handlePOST " + exchange.getRequestText());
        exchange.accept();
    ...
    public void handlePUT(CoapExchange exchange) {
        // ...
        CommUtilsOrig.outmagenta(getName() + " | handlePUT " + exchange.getRequestText()); //.getRequestText()
    ...
    protected void buildAnswer(CoapExchange exchange){
        try {
            ...
            IApplMessage reply = CommUtilsOrig.buildReply("consumer", "outdata", m, message.msgSender());
            CommUtilsOrig.outgreen(getName() + " | build reply: " + reply.toString());
