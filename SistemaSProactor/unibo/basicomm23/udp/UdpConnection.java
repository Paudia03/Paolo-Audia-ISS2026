...
public class UdpConnection extends Connection {//implements Interaction{
...
protected boolean closed;
	...
	public void forward(String msg)  throws Exception {
		CommUtilsOrig.outyellow( "    +++ UdpConnection | forward  " + msg   );
		...
		try {
	        ...
	        socket.send(packet);
			CommUtilsOrig.outyellow( "    +++ UdpConnection | has sent   " + msg  );
		} catch (IOException e) {
			CommUtilsOrig.outred( "    +++ UdpConnection | forward ERROR " + e.getMessage());
			throw e;
		}	
	}
	...
	public String receiveMsg()  {
		String line;
 		try {
			...
			CommUtilsOrig.outyellow( "    +++ UdpConnection | receiveMsg  " + line   );
			return line;
		} catch ( Exception e ) {
			CommUtilsOrig.outred( "    +++ UdpConnection | receiveMsg ERROR  " + e.getMessage() );
	 		return null;
		}		
	}
	...
	public void close() {
		try {
			...
			CommUtilsOrig.outred( "    +++ UdpConnection | close ERROR  " + e.getMessage() );
		}
		closed = true;
		CommUtilsOrig.outyellow( "    +++ UdpConnection | closing   "  );
		socket.close();
	}
