		...
		return { //this:ActionBasciFsm
				...
				state("flashOn") { //this:State
					action { //it:State
						...
						forward("cellstate", "cellstate(12,9,1)" ,"griddisplay" ) 
						delay(BlinkTime)
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
				...
				state("flashOff") { //this:State
					action { //it:State
						...
						forward("cellstate", "cellstate(12,9,0)" ,"griddisplay" ) 
						delay(BlinkTime)
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
